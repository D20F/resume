<template>
    <div class="box">
        ...
        <ul class="content">
            ...
            <li class="circle" type="circle">
                该小程序基于Uniapp开发,页面通过u-view快速构建开发。
            </li>
            <li class="circle" type="circle">
        ...
        <ul class="content">
            ...
            <li class="circle" type="circle">
                对于数据过多的页面,使用虚拟列表和下拉懒加载保证页面性能。
            </li>
            <li class="circle" type="circle">
                对于多次复用的逻辑,使用混入、过滤器、自定义指令进行统一封装。保证代码的复用及简洁性。
            </li>
            <!-- 这个cdn 引入打包 待定 容易吹错 -->
            <li class="circle" type="circle">
...
export default {
    data() {
        return {
            user: [
                { text: "年龄: 22", icon: require("@/assets/柱形图.png") },
                { text: "学历: 专科", icon: require("@/assets/学历.png") },
                {
                    text: "手机: 18871349220",
                    icon: require("@/assets/手机 (1).png"),
                },
            ],
            users: [
                {
                    text: "工作经验: 2年",
                    icon: require("@/assets/工作经验.png"),
                },
                {
                    text: "专业: 计算机网络",
                    icon: require("@/assets/专业.png"),
                },
                {
                    text: "邮箱: d2442563148@163.com",
                    icon: require("@/assets/邮箱.png"),
                },
            ],
        };
    },
